...
// remplace les anciennes defs internes
import useCommanderResolution from "./hooks/useCommanderResolution";
// utilitaires cartes
import {
  nameOf, oracle, isCommanderLegal, getCI, unionCI,
  priceEUR, edhrecScore, distinctByName, identityToQuery,
  bundleCard, bundleByName, primaryTypeLabel
} from "./utils/cards";

// API scryfall (utilisée dans generate/fetchPool etc.)
