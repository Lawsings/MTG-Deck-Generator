...
function CardModal({open, card, owned, onClose}){
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4" onClick={onClose}>
      <div className="rounded-2xl max-w-3xl w-full grid md:grid-cols-2 gap-4 p-4 glass-strong" style={{ background: 'var(--panel-strong)', border: '1px solid var(--border)', color: 'var(--text)' }} onClick={(e)=>e.stopPropagation()}>
